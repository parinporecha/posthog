    ...
    def _build_survey_data(
        ...
        *,
        ...
        if target_url is not None:
            ...
            match_type = URL_MATCH_ALIASES.get(target_url_match or "contains", "icontains")
            conditions["urlMatchType"] = match_type
...
class EditSurveyTool(MaxTool):
    ...
    async def _arun_impl(
        ...
        try:
            ...
            # Build conditions from targeting fields
            conditions: dict[str, Any] = {}
            if target_url is not None:
                conditions["url"] = target_url
                match_type = URL_MATCH_ALIASES.get(target_url_match or "contains", "icontains")
            ...
            if linked_flag_variant is not None:
                conditions["linkedFlagVariant"] = linked_flag_variant
            if conditions:
                existing_conditions = survey.conditions or {}
