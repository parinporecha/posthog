...
async def create_realtime_cohort_calculation_schedule(
    ...
    Args:
        duration_percentile_min: Minimum duration percentile threshold (e.g., 0.0 for p0)
        duration_percentile_max: Maximum duration percentile threshold (e.g., 90.0 for p90)
        interval_minutes: Schedule interval in minutes (default: 60 for every hour)
    """
