...
export function getDefaultConfig(): PluginsServerConfig {
    return {
        ...
        ERROR_TRACKING_CONSUMER_GROUP_ID: 'error-tracking-ingestion',
        ERROR_TRACKING_CONSUMER_CONSUME_TOPIC: KAFKA_EXCEPTIONS_INGESTION,
        ...
        CYMBAL_BASE_URL: process.env.CYMBAL_BASE_URL || 'http://localhost:3302',
        CYMBAL_TIMEOUT_MS: 30000,
        ERROR_TRACKING_CONSUMER_LANE: null,
        ...
        ERROR_TRACKING_TOPHOG_PIPELINE: 'error_tracking',
