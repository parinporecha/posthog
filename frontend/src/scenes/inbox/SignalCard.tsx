...
function LlmEvalSignalCard({ signal, extra }: { signal: SignalNode; extra: LlmEvaluationSignalExtra }): JSX.Element {
    return (
        <div className="border rounded p-3 bg-surface-primary">
            <SignalCardHeader signal={signal} />
...
function isLlmEvalExtra(extra: Record<string, unknown>): extra is Record<string, unknown> & LlmEvaluationSignalExtra {
